	...
	<div id="topbar" class="navbar navbar-expand-md fixed-top navbar-dark bg-success">
		<div class="container-fluid">
			<a class="navbar-brand" href="<?php echo base_url()?>Home">
				<img class="img-responsive" src="<?php echo base_url()?>assets/images/logo.png" /> PERMIS            </a>
		</div>
	</div>
	<div id="main-content" style="background-color: #0b2e13">
						...
						<div class="col-md-4 comp-grid">
							...
							<div  class="bg-light p-3 animated fadeIn page-content">
								<div>
									...
									<?php } ?>
									<form name="loginForm" action="<?php echo base_url()?>auth/reset_password" class="needs-validation form page-form" method="post">
										<div class="input-group form-group">
											<input placeholder="PERSAL NUMBER" name="persal"  required="required" class="form-control" type="text"  />
											<div class="input-group-append">
												<span class="input-group-text"><i class="form-control-feedback fa fa-user"></i></span>
											</div>
										</div>
										<div class="input-group form-group">
											<input  placeholder="NEW PASSWORD" required="required" name="password" class="form-control " type="password" />
											<div class="input-group-append">
										...
										<div class="form-group text-center">
											<button class="btn btn-primary btn-block btn-md" type="submit">
												...
												Update Password <i class="fa fa-key"></i>
											</button>
										</div>
										<hr />
										<div class="form-group text-center">
											<a href="<?php echo base_url()?>" class="btn btn-info text-white text-decoration-none btn-block btn-md" type="submit">
												<i class="load-indicator">
													<clip-loader :loading="loading" color="#fff" size="20px"></clip-loader>
												</i>
