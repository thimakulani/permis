...
<div>
	...
	<h4 style="font-weight: bold" align="center">PERFORMANCE PERIOD: 01 October 2019 to 31 March 2020</h4>
					...
					echo '
								<tr>
									...
									<td class="form-inline">
										<a class="btn-sm btn-danger" style="margin: 3px" href="' . base_url() . 'performance/remove_mou/6/' . $m['OpMouId'] . '">REMOVE</a>
									
										<a class="btn-sm btn-info" style="margin: 3px" href="' . base_url() . 'performance/edit/6/' . $m['OpMouId'] . '">EDIT</a>
									</td>
								</tr>
								';
				}
...
<br/>
<form action="<?php echo base_url()?>performance/submit_performance_mou/6" method="post">
...
<div><br>
	<table class="table table-bordered">
		...
		<tbody>
		<tr>
			<td><h5>Not Effective</h5></td>
			<td><h5>0% - 66%</h5></td>
		</tr>
		<tr>
			<td><h5>Partial Effective</h5></td>
			<td><h5>67% - 99%</h5></td>
		</tr>
		<tr>
			<td><h5>Fully Effective</h5></td>
			<td><h5>100% - 119%</h5></td>
		</tr>
		<tr>
			<td><h5>Highly Effective</h5></td>
			<td><h5>120% - 133%</h5></td>
		</tr>
		</tbody>
	</table>
