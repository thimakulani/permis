	...
	<div class="row card-body">
		<div class="col table-responsive">
			<table class="table table-bordered">
				...
				<tbody>
				<tr>
					<td>AG Weighting <input disabled class="form-control" required type="number" value="<?php if(isset($auditor_general_opinion_and_findings)) echo $auditor_general_opinion_and_findings->ag_weight ?>" name="ag_weight" ></td>
					<td>AG assessment score (rating 0-3) <input disabled required min="1" max="3" value="<?php if(isset($auditor_general_opinion_and_findings)) echo $auditor_general_opinion_and_findings->ag_assessment_score ?>" name="ag_assessment_score" class="form-control" type="number"> </td>
				</tr>
				<tr>
					<td>Weighted Score/rating</td>
					<td><input disabled class="form-control" value="<?php if(isset($auditor_general_opinion_and_findings)) echo $auditor_general_opinion_and_findings->ag_weight/$auditor_general_opinion_and_findings->ag_assessment_score; ?>" type="number"></td>
				</tr>
				</tbody>
			</table>
		</div>
		<div class="col table-responsive">
			<table class="table table-bordered">
				...
				<tbody>
				<tr>
					<td>APP Weighting <input required disabled value="<?php if(isset($auditor_general_opinion_and_findings)) echo $auditor_general_opinion_and_findings->app_weight ?>" name="app_weight" class="form-control" type="number"></td>
					<td>
						Number of Planned Targets <input required disabled value="<?php if(isset($auditor_general_opinion_and_findings)) echo $auditor_general_opinion_and_findings->num_planned_targets ?>" name="num_planned_targets" class="form-control" type="number">
