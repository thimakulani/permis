...
{?>
	<div class="card">
		<div class="card-body">
			<form class="form-inline"  method="post" action="<?php echo base_url()?>performance/sup_update_status_correction/<?php echo $data->id; ?>">

				<input type="submit" value="Submit Update" class="btn-sm btn-primary m-2" />
			</form>
		</div>
	</div>
<?php } ?>
