<div class="modal-dialog" role="document">
	<div class="modal-content">
		<div class="modal-header">
			<h5 class="modal-title">MEMOS AND SCHEDULES</h5>
			<a href="<?php echo base_url()?>library/memo_and_schedule" class="close" >
		...
		<form enctype="multipart/form-data" action="<?php echo base_url()?>library/create" method="post">
			<div class="modal-body">
				<div class="card-body">
					<input type="hidden" name="file_type" value="MEMOS AND SCHEDULES">
					<input type="hidden" name="navigation" value="memo_and_schedule">
