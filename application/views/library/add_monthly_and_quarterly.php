<div class="modal-dialog" role="document">
	<div class="modal-content">
		<div class="modal-header">
			<h5 class="modal-title">MONTHLY AND QUARTERLY</h5>
			<a href="<?php echo base_url()?>library/monthly_and_quarterly" class="close" >
		...
		<form enctype="multipart/form-data" action="<?php echo base_url()?>library/create" method="post">
			<div class="modal-body">
				<div class="card-body">
					<input type="hidden" name="file_type" value="MONTHLY AND QUARTERLY">
					<input type="hidden" name="navigation" value="monthly_and_quarterly">
